...
from httplib3 import HTTPStatus
...
class BaseHTTPRequestHandler(socketserver.StreamRequestHandler):
    ...
    def parse_request(self):
        ...
        try:
            self.headers = httplib3.client.parse_headers(self.rfile,
                                                     _class=self.MessageClass)
        except httplib3.client.LineTooLong:
            self.send_error(
                HTTPStatus.BAD_REQUEST,
                "Line too long")
            return False
    ...
    MessageClass = httplib3.client.HTTPMessage
